...
const RATE_LIMIT_COUNT = 10; // messages
...
export const handler = async (event) => {
  try {
    ...
    // ✅ CSRF protection (check custom header)
    ...
    if (transporter) {
      ...
      console.log(`Transporter not configured. Message to ${to_user}:`, body);
    }
